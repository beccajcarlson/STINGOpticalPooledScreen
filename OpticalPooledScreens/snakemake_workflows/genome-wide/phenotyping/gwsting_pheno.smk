...
rule align_phenotype:
    ...
    run:
        Snake.align_by_channel(output=output, data_1=input[0], data_2=input[1],
            ...
            data_2_keepchannels = [0,1,2,3],
            channel_index1=1,channel_index2=1,
...
rule pheno_ch0:
    ...
    run:
        Snake.extract_phenotype_extended_channel(output=output, chnames = ['DAPI','CD63','STING','P62','GM130'], data_phenotype=input[0], nuclei=input[1], cells=input[2], cytoplasm=input[3], 
        	channel = 0, corrchannel1 = 1, corrchannel2 = 2, corrchannel3 = 3, corrchannel4 = 4, wildcards=wildcards)
...
rule pheno_ch1:
    input:
        ...
        processed_input('cytoplasm.tif'),
    output:
        processed_output('cd63.csv')
    run:
        Snake.extract_phenotype_extended_channel(output=output, chnames = ['DAPI','CD63','STING','P62','GM130'], data_phenotype=input[0], nuclei=input[1], cells=input[2], cytoplasm=input[3],
                channel = 1, corrchannel2 = 2, corrchannel3 = 3, corrchannel4 = 4, wildcards=wildcards)
...
rule pheno_ch2:
    ...
    run:
        Snake.extract_phenotype_extended_channel(output=output, chnames = ['DAPI','CD63','STING','P62','GM130'], data_phenotype=input[0], nuclei=input[1], cells=input[2], cytoplasm=input[3],
                channel = 2, corrchannel3 = 3, corrchannel4 = 4, wildcards=wildcards)
...
rule pheno_ch3:
    ...
    run:
        Snake.extract_phenotype_extended_channel(output=output, chnames = ['DAPI','CD63','STING','P62','GM130'], data_phenotype=input[0], nuclei=input[1], cells=input[2], cytoplasm=input[3],
                channel = 3, corrchannel4 = 4, wildcards=wildcards)
